...
if (platform.system() == "Darwin"):
    ...
    OPUSREADER_PATH = "opusreader"
    POWER_SHELL = "pwsh"
else:
    # cached audio files will be stored in this directory
    DATA_FOLDER = "D:\\tts-output\\"
    OPUSREADER_PATH = "opusreader.exe"
...
class Manager:
    ...
    def highlight_line(self, line_text):
        subprocess.run([OPUSREADER_PATH, "--focus-text", '"{}"'.format(line_text), "--focus-text-page", str(self.current_state[1]), "--nofocus"])
