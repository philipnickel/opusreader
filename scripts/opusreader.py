...
class OpusReader:
    ...
    def __init__(self, opusreader_path, local_database_path=None, shared_database_path=None):
        self.path = opusreader_path
...
class Document:
    ...
    def __init__(self, path, opusreader):
        self.path = path
        self.doc = fitz.open(self.path)
        self.set_page_dimensions()
        self.opusreader = opusreader
    ...
    def highlight_selection(self, page_number, selection_begin, selection_end, focus=False):
        ...
        self.opusreader.keyboard_select(highlight_string, focus=focus)
    ...
    def get_hash(self):
        path_hash_map = self.opusreader.get_path_hash_map()
    ...
    def get_bookmarks(self):
        ...
        shared_database = self.opusreader.get_shared_database()
